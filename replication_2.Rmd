...
```{r}
# All of these chunks have been copied below so we do not need them
...
for(subset in subsets){
	...
	for(j in 1:length(repeats)){
		dat.subset$x.new = (as.numeric(dat.subset[,x.names[j]])-1)/4  ##rescale x to 0-4 then 0-1
		dat.subset$y.new = (as.numeric(dat.subset[,y.names[j]])-1)/4  ##rescale y to 0-4 then 0-1
